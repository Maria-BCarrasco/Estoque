        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-9 col-xl-8">
                    ...
                    <div class="mb-4">
                        <h1 class="h3 fw-bold text-dark mb-1">Adicionar Novo Usuário</h1>
                        <p class="text-secondary mb-0">Cadastre um novo usuário no sistema</p>
                    </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold d-flex align-items-center gap-1">
                                            <i class="bi bi-person text-primary"></i> Nome Completo <span class="text-danger">*</span>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold d-flex align-items-center gap-1">
                                            <i class="bi bi-shield-lock text-primary"></i> Perfil de Acesso <span class="text-danger">*</span>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold d-flex align-items-center gap-1">
                                            <i class="bi bi-diagram-3 text-primary"></i> Departamento <span class="text-danger">*</span>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold d-flex align-items-center gap-1">
                                            <i class="bi bi-building text-primary"></i> Unidade Hospitalar <span class="text-danger">*</span>
                                        </label>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-semibold d-flex align-items-center gap-1">
                                            <i class="bi bi-key text-primary"></i> Senha Temporária <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control" placeholder="Será enviada por e-mail" wire:model="senha_temporaria">
                                    </div>
                                </div>

                                <div class="alert alert-primary d-flex align-items-center gap-2 mt-4 mb-0" role="alert">
